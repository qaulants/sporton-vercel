...
const LoginPage = () => {
  ...
  // submit berdasarkan yang sudah kita simpan
  const handleLogin = async () => {
    ...
    try {
      ...
      setIsloading(false) // tandanya sudah selesai
    }
  }

  return ( 
    <main className="bg-[#F7F9FA] w-full min-h-screen flex justify-center items-center">
      <div className="max-w-136 w-full bg-white rounded-xl border-t-4 border-primary shadow-lg py-12 px-[72px]">
        <Image 
        ...
        <div className="input-group-admin mb-5">
          ...
          <input  
            ...
            id="email" 
            name="email" 
            placeholder="Please type your email" className="rounded-lg"
            value={email}
