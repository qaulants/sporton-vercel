...
type TProductodalProps = {
  isOpen: boolean;
  onClose: () => void;
};

const ProductModal = ({isOpen, onClose}: TProductodalProps) => {
      ...
      <div className="flex flex-col gap-6">
        <div className="flex gap-7">
          <div className="min-w-50">
            <p className="py-[2px] text-[12px]">Product Image</p>
            <ImageUploadPreview 
              label="Product Image" 
              value={imagePreview} 
              onChange={(file) => {
          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="input-group-admin">
                ...
                <input type="number" id="stock" name="stock" placeholder="e. g. 500000" />
              </div>
            </div>
            <div className="input-group-admin">
