    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Verify Transactions">
      <div className="flex gap-6">
        <div className="min-w-50">
          <h4 className="font-semibold text-sm mb-2">Payment Proof</h4>
          {
            transaction.paymentProof ? (
              <Image 
                src="/images/payment.png" alt="payment proof" 
                width={200} 
                height={401} 
              />
            ) : (
        ...
        <div className="w-full">
          ...
          <div className="bg-gray-100 rounded-md flex-col gap-2.5 p-4 text-sm mb-5">
              ...
              <div key={index} className="border border-gray-200 rounded-lg p-2 flex items-center gap-2">
                ...
                {item.productId ? (
                  ...
                  <>
                    ...
                    <div className="font-medium text-sm">Product ID: null</div>
                  </>
                )}
          ...
          <div className="flex justify-end gap-5 mt-12">
            {
              isUpdating ? (
                ...
                <>
                  ...
                  <Button 
                    className="text-green-50! bg-green-500! rounded-md" size="small"
